...
export default function Income({tasks}) {
  // State for sorting and filtering dropdowns
    ...
    <>
      <div className="border rounded-md">
        ...
        <div className="flex items-center justify-between gap-2 bg-[#F9FAFB] py-4 px-4 rounded-md">
          ...
          <div className="flex gap-4">
            ...
            <div className="relative inline-block text-left">
              ...
              {/* Conditional rendering for Sorting Dropdown */}
              {isSortingOpen && (
                <div
            ...
            <div className="relative inline-block text-left">
              ...
              {/* Conditional rendering for Filtering Dropdown */}
              {isFilteringOpen && (
                <div
        ...
        <div className="p-4 divide-y">
          {/* <!-- Expense Row 1 --> */}
          {tasks.map((task) => (
          <div   key={task.id} className="flex justify-between items-center py-2 relative group cursor-pointer">
            <div>
              <h3 className="text-base font-medium leading-7 text-gray-600">
              {task.category || 'Unknown Category'}
              </h3>
              <p className="text-xs text-gray-600"> {task.date || 'No Date Provided'}</p>
            </div>
            <div className="flex items-center gap-2">
